 ...
 *
 * @module @simple-ui/reflow
 * @license
 * @simple-ui/reflow 1.0.0 <https://simple-ui.io/>
 * Copyright 2017 Adaptive UI <https://simple-ui.io/>
...
Reflow.prototype = {
  ...
  ruleAt(index, orderFn) {
    return this.rule((requestedIndex) => {
 ...
 *
 * @module @simple-ui/workflow
 * @license
 * @simple-ui/workflow 1.0.0 <https://simple-ui.io/>
 * Copyright 2017 Adaptive UI <https://simple-ui.io/>
 * Available under MIT license <https://simple-ui.io/license>
 */
...
Workflow.create = function create(source) {
  return new Workflow(source);
};
...
Workflow.prototype = {
  ...
  scanIndex(conditionFn, progressionIncrement = 1) {
    ...
    let scanIndex = (progressionIncrement > 0)
      ? this.peekNextIndex()
  ...
  reflow(reflowName) {
    ...
    let reflow = this.__reflow__ = new Reflow();
